...
import { X, Server, RefreshCw, Loader2, Wifi, Cpu, Sparkles, Users } from "lucide-react";
          ...
          <div className="flex items-center justify-between p-5 border-b border-border/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Configure connection</p>
              </div>
            </div>
            <button
              onClick={() => onOpenChange(false)}
              ...
              {serverStatus ? (
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-muted/50 rounded-xl p-4">
                    ...
                    <Badge
                      variant={serverStatus.config.useMockAI ? "secondary" : "default"}
                  ...
                  <div className="bg-muted/50 rounded-xl p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-muted-foreground">Refinement</span>
                    </div>
                    <Badge
                      className={`rounded-full ${
                      ...
                      variant={serverStatus.config.enableRefinement ? "default" : "secondary"}
                    >
